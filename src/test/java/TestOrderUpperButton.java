...
public class TestOrderUpperButton {
    ...
    public TestOrderUpperButton(String testName, String testSurname, String testAdress, String testPhoneNumber, String testComment) {
